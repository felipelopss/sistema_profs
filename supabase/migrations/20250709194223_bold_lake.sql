/*
  ...
  1. Tabelas principais
    ...
    - time_slots: Horários
    - class_subjects: Associação disciplina-turma
  ...
  2. Segurança
    ...
    - Políticas para acesso baseado em roles
*/
...
INSERT INTO users (id, name, email, role, registration_number, phone, password_hash, created_at, updated_at)
VALUES (
  'admin-default-id',
  'Administrador',
  'admin@escola.com',
